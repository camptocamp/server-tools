...
class MethodOverload(models.Model):
    ...
    method_name = fields.Char(
        string="Name", help="The name of the overloaded method",
    )
    method_model = fields.Char(
        string="Model", help="The name of the overridden model",
    )
    method_module = fields.Char(
        string="Module",
        help="The name of the module where the method is overloaded.",
    )
    ...
    method_delegate_name = fields.Char(
        help=(
            "The name of the method that will be used to alter the output of the overloaded method."
        )
    )
    method_class_name = fields.Char(
        string="Class Name",
        help="The class name, as written in the python file."
    )
