...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:30b876ea608454c7036df28557f87027b05e4143e45985b192650237b1b16335
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
``BaseModel.write()`` override will take care of filtering out the field
values that are the same as the record's current ones. You can use this
to override a model's ``write()`` method to prevent unnecessary changes,
or use it to make sure you don't update a field unless its current value
is different from the one you want to set.
